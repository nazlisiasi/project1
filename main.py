...
while i < len(input_dict['vm_details']):
   ...
   print "KEY ", input_dict['vm_details'][i]['key']
   ssh_command = '/home/ec2-user/' + input_dict['vm_details'][i]['key'] + ' ' + input_dict['vm_details'][i]['mgmt_ip'] 
   child = pexpect.spawn( 'ssh -i '+ ssh_command)
   child.expect (prompt)
