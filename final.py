...
for test_entry in input_dict['tests']:
  ...
  #     cmd = "pssh -H " +  src_ip  + " -x \"-oStrictHostKeyChecking=no  -i key.pem\" -P 'ping -c 3 " + des_ip + "'"
    ...
    if test_entry['test_type'] == 'tcp':
        ...
        cmd_client = "pssh -H " + des_ip + " -x \"-oStrictHostKeyChecking=no  -i " + des_key + "\" -P 'iperf3 -c " + src_ip + " -p 1114 -P 2 -t 2 '"
    ...
    if test_entry['test_type'] == 'udp':
        ...
        cmd_client2 = "pssh -H " + des_ip + " -x \"-oStrictHostKeyChecking=no  -i " + des_key + "\" -P 'iperf3 -c " + src_ip + " -p 1114 -P 2 -t 10 -u '"
